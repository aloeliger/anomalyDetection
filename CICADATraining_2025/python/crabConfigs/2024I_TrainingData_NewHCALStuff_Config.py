...
config.General.requestName = 'CICADATraining2025_2024I_24Mar2025'
...
#config.JobType.pyCfgParams=['isData=True', 'includeNPVNtuplizer=True', 'useHCALOverride=True', 'useCaloParamsOverride=True']
config.JobType.pyCfgParams=['isData=True', 'useHCALOverride=True', 'useCaloParamsOverride=True']
...
config.Data.outputDatasetTag = 'CICADATraining2025_2024I_24Mar2025'
