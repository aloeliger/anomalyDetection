...
def main():
    ...
    json_output_location = f'{cmssw_base}/src/anomalyDetection/CICADATraining_2025/metadata/unprescaled_combined_trigger_list.json'

    with open(json_output_location, 'w') as theFile:
        json.dump(unprescaled_triggers, theFile, indent=4)
