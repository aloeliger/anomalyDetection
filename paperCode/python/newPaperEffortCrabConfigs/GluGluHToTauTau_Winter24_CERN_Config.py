...
config.General.requestName = f'AnomalyDetectionPaper2025_GluGluHToTauTau_Winter24_CERN_{today}'
...
config.Data.outputDatasetTag = f'AnomalyDetectionPaper2025_GluGluHToTauTau_Winter24_CERN_{today}'
