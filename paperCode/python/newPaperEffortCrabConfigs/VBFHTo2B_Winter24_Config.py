...
config.General.requestName = f'AnomalyDetectionPaper2025_VBFHTo2B_Winter24_{today}'
...
config.Data.outputDatasetTag = f'AnomalyDetectionPaper2025_VBFHTo2B_Winter24_{today}'
