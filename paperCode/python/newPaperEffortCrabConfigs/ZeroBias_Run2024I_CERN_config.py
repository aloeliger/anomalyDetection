...
config.General.requestName = f'AnomalyDetectionPaper2025_ZeroBias_Run2024I_CERN_{today}'
...
config.Data.outputDatasetTag = f'AnomalyDetectionPaper2025_ZeroBias_Run2024I_CERN_{today}'
