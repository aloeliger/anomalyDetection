...
config.General.requestName = f'AnomalyDetectionPaper2025_VBFHToTauTau_Winter24_{today}'
...
config.Data.outputDatasetTag = f'AnomalyDetectionPaper2025_VBFHToTauTau_Winter24_{today}'
