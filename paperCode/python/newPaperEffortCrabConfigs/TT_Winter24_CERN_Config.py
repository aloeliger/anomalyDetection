...
config.General.requestName = f'AnomalyDetectionPaper2025_TT_Winter24_CERN_{today}'
...
config.Data.secondaryInputDataset='/TT_TuneCP5_13p6TeV_powheg-pythia8/Run3Winter24Digi-133X_mcRun3_2024_realistic_v8-v2/GEN-SIM-RAW'
config.Data.inputDBS = 'global'
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 1
config.Data.publication = False
config.Data.outputDatasetTag = f'AnomalyDetectionPaper2025_TT_Winter24_CERN_{today}'
